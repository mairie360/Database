...
DELETE FROM group_users WHERE user_id IN (400, 401, 402);
...
---
INSERT INTO groups (id, owner_id, owner_is_archived, name) VALUES (60, 400, false, 'Alpha Group');
INSERT INTO group_users (group_id, user_id) VALUES (60, 402);
