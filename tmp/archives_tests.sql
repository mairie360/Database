...
-- VALUES (401, 'old_hash_123', now(), now() - interval '7 months');
...
-- INSERT INTO connection_logs (user_id, ip_address, action_type, timestamp)
-- VALUES (401, '127.0.0.1', 'LOGIN', now() - interval '14 months');
